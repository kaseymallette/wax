...
The site is deployed through Cloudflare Pages and hosted on my custom domain, [waxweekly.com](https://waxweekly.com).

Each daily playlist can be explored directly on Wax Weekly or opened in Spotify.

**Live site:** https://waxweekly.com  
